...
# Configuration Script – PAB0001-01 - Rev. A

This **Configuration** script is designed for the **PAB0001-01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – PAB0001-01 Rev. A

Este script de **Configuration** está diseñado para el modelo **PAB0001-01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
